...
const EditProfile = ({createProfile,getProfileOfUser,profileOb:{profile,loading}}) => {
...
const mapStateToProps=state=>({
    profileOb:state.profile.profile
})
export default connect(mapStateToProps,{createProfile,getProfileOfUser})((EditProfile));
