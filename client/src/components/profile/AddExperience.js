...
const AddExperience = ({addExperience}) => {
    ...
    function onSubmit(e){
        e.preventDefault();
        const newExp=JSON.stringify(FormData);
  ...
  return (
    <Fragment>
      ...
      <form class="form" onSubmit={(e)=>onSubmit(e)}>
        ...
        <div class="form-group">
          <input type="text" placeholder="* Company" name="company" onChange={(e)=>onChange(e)} required value={company}/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <p><input type="checkbox" name="current" checked={current} value={current} onChange={()=>setFormData({...FormData,current:!current})} /> Current Job</p>
        </div>
